...
const products = [
  {
    ...
    price: 999,
    category: "celulares",
    imageUrl: "/images/Apple-iPhone-16-hero-240909_inline.jpg.large.jpg",
  },
  {
    id: 2,
    name: "MacBook Pro",
    ...
    imageUrl:
      "/images/MacBook_Pro_16-in_Space_Gray_PDP_Image_Position-1__MXLA.jpeg",
  },
  {
    id: 3,
    name: "PlayStation 5",
        ...
        {dropdownOpen && (
          <div className="origin-top-left absolute mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-10">
            ...
            >
              ...
              <button
                onClick={() => setCategory("computadoras")}
                className="block w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
              >
                Computadoras
              </button>
              <button
                onClick={() => setCategory("consolas")}
                className="block w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
              >
                Consolas de Juego
              </button>
