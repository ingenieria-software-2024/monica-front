...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-900 p-4 fixed top-0 left-0 w-full z-50">
      {" "}
      {/* Clases para hacerlo fijo y siempre visible */}
      <div className="flex justify-between items-center">
        ...
        <ul
          className={`flex items-center md:space-x-4 ${isOpen ? "flex" : "hidden"} md:flex`}
        >
          <li>
            ...
            <Link to="/cart" className="text-white flex items-center">
              ...
              >
                <path
                  ...
                  strokeWidth={2}
                  d="M3 3h2l1 9h13l1-9h2M7 18c-1.104 0-2 .896-2 2s.896 2 2 2 2-.896 2-2-.896-2-2-2zm10 0c-1.104 0-2 .896-2 2s.896 2 2 2 2-.896 2-2-.896-2-2-2z"
                />
              </svg>
              Carrito
            </Link>
