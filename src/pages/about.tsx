    ...
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col items-center justify-center p-4">
        ...
        <p className="text-center">
          ...
          Aquí ofrecemos una amplia gama de artículos, incluyendo 
          celulares, computadoras, consolas de juegos y más.
        </p>
        <p className="text-center mt-4">
          Nuestro objetivo es proporcionar los mejores productos y servicios 
          para satisfacer todas tus necesidades electrónicas. ¡Gracias por visitarnos!
        </p>
      </div>
      <br />
      ...
      <div className="flex flex-row justify-center gap-4 mt-8 mb-16"> {/* Añadir 'mb-16' para separar del footer */}
        {/* Tarjeta Misión */}
        <div className="service-card w-[300px] shadow-xl cursor-pointer snap-start shrink-0 py-8 px-6 bg-white flex flex-col items-start gap-3 transition-all duration-300 group hover:bg-[#202127]">
          ...
          <p className="font-bold text-2xl group-hover:text-white text-black/80">Nuestra Misión</p>
          <p className="text-gray-400 text-sm">
            Ofrecer productos tecnológicos de alta calidad y un excelente servicio al cliente.
          </p>
        </div>
        ...
        <div className="service-card w-[300px] shadow-xl cursor-pointer snap-start shrink-0 py-8 px-6 bg-white flex flex-col items-start gap-3 transition-all duration-300 group hover:bg-[#202127]">
          ...
          <p className="font-bold text-2xl group-hover:text-white text-black/80">Nuestra Visión</p>
          <p className="text-gray-400 text-sm">
        ...
        <div className="service-card w-[300px] shadow-xl cursor-pointer snap-start shrink-0 py-8 px-6 bg-white flex flex-col items-start gap-3 transition-all duration-300 group hover:bg-[#202127]">
          ...
          <p className="font-bold text-2xl group-hover:text-white text-black/80">Nuestros Objetivos</p>
          <p className="text-gray-400 text-sm">
            Innovar continuamente en tecnología para ofrecer lo mejor a nuestros clientes.
          </p>
        </div>
      </div>
    </div>
